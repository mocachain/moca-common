...
Support common libs for different repos of moca
...
Hash package support methods to compute the integrity hash of moca objects , the computed methods is based on
redundancy strategy of moca. Function as follows:
